...
<div id="comment-{{ $comment->id }}" class="mb-4 bg-white rounded-lg shadow p-4">
    <div class="flex items-start space-x-3">
        ...
        <div class="flex-1">
            ...
            <!-- Zone de réponse -->
            <div id="reply-input-{{ $comment->id }}" class="reply-input mt-3 ml-8" style="display: none;">
                <form action="{{ route('comments.reply', $comment) }}" method="POST" class="reply-form" data-comment-id="{{ $comment->id }}">
                    @csrf
