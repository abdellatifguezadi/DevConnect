        ...
        <div class="max-w-[1128px] mx-auto px-4 pt-20">
            ...
            <div class="bg-white rounded-lg shadow p-6 mb-4">
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        <h1 class="text-2xl font-bold text-gray-900">{{ $lang->name }}</h1>
                        <p class="text-gray-500">{{ $lang->posts_count }} publication{{ $lang->posts_count > 1 ? 's' : '' }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="space-y-4">
                ...
                <div class="bg-white rounded-lg shadow p-6 text-center">
                    <p class="text-gray-500">Aucune publication avec ce language</p>
                </div>
                @endforelse
